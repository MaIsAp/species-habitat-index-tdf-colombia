...
for i in times
    res, wkt, transform = Omniscape.read_raster(string(outputFolder,"/",sp,"_resist_layer_",i,".tif"), Float64)
    #sou, wkt2, transform = Omniscape.read_raster(string(outputFolder,"/",sp,"_source_layer_",i,".tif"), Float64)
    
    config = Dict{String, String}(
    "resistance_file" => string(outputFolder,"/",sp,"_resist_layer_",i,".tif"),
    "source_file" => string(outputFolder,"/",sp,"_source_layer_",i,".tif"),
    ...
    "project_name" => string(outputFolder,"/","Omniscape",i),
    "mask_nodata" => "true",
